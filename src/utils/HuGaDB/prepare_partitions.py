...
def prepare_partitions(client_idx, trial_seed, sample_size, num_corrupted_clients, train_files_pattern, corruption_params, label_corruption_prob , label_encoder):
    ...
    df_train_local, _ = train_test_split(df_train_local, train_size=sample_size, random_state=trial_seed, stratify=df_train_local['act'])
