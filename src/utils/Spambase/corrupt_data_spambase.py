...
def corrupt_data(X: np.ndarray,  y: np.ndarray, corruption_prob: float = 0.8, nan_prob: float = 0.5, noise_std: Optional[float] = None, label_corruption_prob: float = 0.2,
    ...
    corruption_mask = np.random.rand(n_samples) < label_corruption_prob  
